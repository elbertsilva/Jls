...
CREATE TABLE `spent` (
  ...
  `chuteira` int DEFAULT NULL,
  `valorChuteira` int DEFAULT NULL,
  `viagem` int DEFAULT NULL,
  `valorViagem` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `spent` VALUES (1,'Joao Gabriel',2,500,2,1500);
...
-- Dump completed on 2021-11-04  8:33:37
